...
/**
 * _staff-agreement.js — CJS mirror of src/lib/templates/staffAgreement.ts
 *
 * Generates the hydrated Mutual Working Agreement text for a given employee.
 * Used by get-employee-contract.js on the serverless side.
 *
 * Keep in sync with the TypeScript source.
 */

/**
 * @param {{ employeeName: string, baseRate: string, effectiveDate: string, noticePeriodDays: number }} data
 * @returns {string}
 */
function generateStaffAgreement(data) {
...
module.exports = { generateStaffAgreement };
