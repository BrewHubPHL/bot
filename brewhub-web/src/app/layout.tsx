...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`scroll-smooth ${inter.variable} ${playfair.variable} antialiased`}>
      <body className="bg-gradient-to-br from-[#f8f4f0] via-[#fdfcfb] to-[#e9ded6] text-[var(--hub-espresso)] min-h-screen flex flex-col">
        {/* Premium Glass Nav */}
        ...
        <main className="flex flex-col flex-1 items-center justify-center w-full mx-auto px-2 sm:px-0 pt-24 pb-12" style={{minHeight:'calc(100vh - 120px)'}}>
          {children}
        </main>
        ...
        <footer className="footer-glass mt-auto">
          <div className="max-w-6xl mx-auto px-6 text-center flex flex-col items-center gap-2">
            <p className="font-semibold text-[1.08rem] text-[var(--hub-espresso)]">© 2026 BrewHubPHL. Point Breeze, Philadelphia.</p>
            <div className="flex flex-wrap justify-center gap-4 mt-1">
              ...
              <a href="/staff" className="nav-link">Staff Portal</a>
            </div>
          </div>
        </footer>
      </body>
